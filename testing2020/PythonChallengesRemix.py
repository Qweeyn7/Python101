...
def convert_seconds(s):
    s = s % (24 * 3600)
    hour = s // 3600
    print("Converted to", hour, "hour/s")
    print()
...
def caculate_profit(product):
  ...
  # add a variable to format the profit, by add ing the $ and formatting decimal
  formatted_profit = format(total_product_profit, '.2f')
  return formatted_profit

profit_for_product_1 = caculate_profit(product_1)
print("Product 1 Total Profit = $", profit_for_product_1)
print()

profit_for_product_2 = caculate_profit(product_2)
print("Product 2 Total Profit = $", profit_for_product_2)
print()

profit_for_product_3 = caculate_profit(product_3)
print("Product 3 Total Profit = $", profit_for_product_3)
print()

total_profit = float(profit_for_product_1) + float(profit_for_product_2) + float(profit_for_product_3)
print("The Total Profit from all inventory is $", total_profit)