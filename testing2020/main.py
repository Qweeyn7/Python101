...
user_profile = UserProfile(user_dob, user_age, user_full_name, user_country, user_state, user_number_of_education_years)
...
user_coding_languages = input("What languages do you know? (separate each language by a comma) \n")
...
for item in expected_salaries:
    ...
    if input("Do you want to enter another candidate? ").upper == "Y":
        loop_val = False
        # create_another_candidate() Working on looping my code here.
    else:
        loop_val = True
    print(user_info)
    print()
